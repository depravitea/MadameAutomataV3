...
export async function execute(i){
  const e=gothicEmbed('Empyrean Setup',['1) Create roles: **Dom**, **Sub**, **Blindfold**','2) Run /config to set IDs','3) Toggle feature flags via /manage-features','4) Use /roles to publish menus'].join('\n'));
